...
IRIS_API bool AlignAndConvertVideoFrame(IrisVideoFrame *dst,
                                        const IrisVideoFrame *src);

IRIS_API void FixYuv420Alignment(IrisVideoFrame &dst_video_frame,
                                 const IrisVideoFrame &video_frame,
                                 int alignment);

IRIS_API void CopyAndCentreYuv(const uint8_t *src_y, int src_stride_y,
